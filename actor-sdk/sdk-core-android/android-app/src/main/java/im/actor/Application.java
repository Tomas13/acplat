...
//        ActorSDK.sharedActor().setCallsEnabled(true);
        ...
        ActorSDK.sharedActor().setEndpoints(new String[]{"tcp://gate.messengercrm.com:9070"});
        ActorSDK.sharedActor().setTrustedKeys(new String[]{"b0b15d0b1e060d78e0c7103564bf5d6c0edd9b59494517aa1f0063ad93ab4816"});
